...
import { FaLinkedinIn, FaInstagram, FaWhatsapp, FaXTwitter, FaFacebookF } from 'react-icons/fa6';
                ...
                {socialLinks.map((item) => {
                  ...
                  return (
                    <a
                      ...
                      className="text-[#9A9A9A] transition-all duration-300 hover:text-[#005F93] hover:-translate-y-1"
                    >
