    ...
    >
      <div className="max-w-container-max mx-auto px-6 md:px-12 grid grid-cols-[1fr_auto_1fr] items-center gap-8">
        ...
        <div className="hidden lg:flex items-center justify-end gap-8 justify-self-end">
          ...
          <Link
            to="/contact"
            className="bg-primary text-white px-8 py-3 text-[12px] font-bold hover:bg-primary-container transition-all tracking-tight uppercase rounded-xl shadow-md hover:shadow-lg active:scale-95"
          >
          ...
          >
            ...
            <div className="mt-auto flex flex-col gap-10">
              <Link
                to="/contact"
                onClick={() => setIsOpen(false)}
                className="bg-primary text-white text-center py-2 text-sm font-bold tracking-[0.2em] uppercase rounded-sm"
              >
                {t('services.cta_button')}
              </Link>
